...
const About = () => {
  return (
    <section id="about" data-testid="section-about" className="py-20 bg-gray-50">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          ...
          <article>
            <div className="flex items-center mb-6">
              <User className="text-blue-600 mr-3" size={32} aria-label="User Icon" />
          ...
          <aside>
            <div className="flex items-center mb-8">
              <Gem size={28} className="text-yellow-500 mr-3" aria-label="Core Values Icon" />
        ...
        {/* Stats Section */}
        <section
          className="mt-16 bg-gradient-to-br from-blue-50 to-indigo-100 rounded-2xl p-8 border border-gray-200 shadow-sm"
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 text-center">
            {[
              ...
              <div key={index} data-testid={`about-stat-${toTestId(stat.label)}`}>
                ...
                <p className="text-sm text-gray-600" data-testid={`about-stat-label-${toTestId(stat.label)}`}>
                  {stat.label}
                </p>
              </div>
            ))}
