...
/**
 * AI Metadata
 * id: AI_TC_PROJECTS_005
 * module: Projects
 * scenario: click github repository link
 * priority: Medium
 * riskLevel: Low
...
class ProjectsClickGithubRepositoryLinkPage {
...
test.describe('Projects', () => {
  test('click github repository link @projects @expanded', async ({ page }) => {
    const app = new ProjectsClickGithubRepositoryLinkPage(page);
